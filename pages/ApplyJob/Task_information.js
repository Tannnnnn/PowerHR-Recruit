...
const enhance = compose(
    ...
    withHandlers({
        ...
        saveThisPageNext: props => () => event => {                       
            ...
            let birthDay = JSON.parse(localStorage.getItem('Personal_page')).birthday.split('-')            
            const years = parseInt(birthDay[0])
            const month = parseInt(birthDay[1]) 
            const days  = parseInt(birthDay[2])                  
            ...
            var docDefinition = {
                content: [
                    ...
                    {
                        text : `ชื่อ (ภาษาไทย)  :  ${JSON.parse(localStorage.getItem('Personal_page')).fname_thai} ${JSON.parse(localStorage.getItem('Personal_page')).lname_thai}    name (English)  :  ${JSON.parse(localStorage.getItem('Personal_page')).fname_eng} ${JSON.parse(localStorage.getItem('Personal_page')).lname_eng}     เพศ  :  ${JSON.parse(localStorage.getItem('Personal_page')).sex}
                ...
                <br/><br/>
                    <MgBTNOrange>
                            <div>
                                ...
                                &nbsp;
                                {/* <Modal trigger={ */}
                                        <Button as='div' labelPosition='right' onClick={props.saveThisPageNext()}>
                                            <BtnSuccess>
                                                ยืนยันการสมัคร
                                            </BtnSuccess>
                                            <Colorlabel as='a'>
